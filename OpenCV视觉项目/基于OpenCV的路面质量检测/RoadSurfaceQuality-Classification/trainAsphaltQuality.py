'''
@FileName   :trainAsphaltQuality.py
@Description:
@Date       :2022/10/10 11:09:50
@Author     :daito
...
#Prepare input data
classes = os.listdir('E:\\Source\\Github\\datasets\\roadsurfacequality-classification\\asphalt_quality')
...
img_size = 128
num_channels = 3
train_path = 'E:\\Source\\Github\\datasets\\roadsurfacequality-classification\\asphalt_quality'
