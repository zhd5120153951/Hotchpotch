'''
@FileName   :trainPavedQuality.py
@Description:
@Date       :2022/10/10 11:14:24
@Author     :daito
...
#Prepare input data
classes = os.listdir('E:\\Source\\Github\datasets\\roadsurfacequality-classification\\paved_quality')
...
img_size = 128
num_channels = 3
train_path = 'E:\\Source\\Github\datasets\\roadsurfacequality-classification\\paved_quality'
