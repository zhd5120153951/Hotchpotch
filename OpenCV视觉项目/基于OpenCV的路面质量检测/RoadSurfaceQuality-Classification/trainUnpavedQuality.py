...
#Prepare input data
classes = os.listdir('E:\\Source\\Github\datasets\\roadsurfacequality-classification\\unpaved_quality')
...
img_size = 128
num_channels = 3
train_path = 'E:\\Source\\Github\datasets\\roadsurfacequality-classification\\unpaved_quality'
