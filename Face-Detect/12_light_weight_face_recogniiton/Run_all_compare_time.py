...
if __name__ == "__main__":
    ...
    cv2.putText(ultraface_result, 'ultraface waste time:' + str(ultraface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1,
                (0, 0, 255))
    ...
    cv2.putText(ssdface_result, 'ssdface waste time:' + str(ssdface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1,
                (0, 0, 255))
    ...
    cv2.putText(retinaface_result, 'retinaface waste time:' + str(retinaface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX,
                1, (0, 0, 255))
    ...
    cv2.putText(retinaface_dnn_result, 'retinaface_dnn waste time:' + str(retinaface_dnn_time), (20, 40),
    ...
    cv2.putText(facebox_result, 'facebox waste time:' + str(facebox_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1,
                (0, 0, 255))
    ...
    cv2.putText(facebox_dnn_result, 'facebox_dnn waste time:' + str(facebox_dnn_time), (20, 40),
                cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255))
    ...
    cv2.putText(dbface_result, 'dbface waste time:' + str(dbface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1,
                (0, 0, 255))
    ...
    cv2.putText(centerface_result, 'centerface waste time:' + str(centerface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX,
                1, (0, 0, 255))
    ...
    cv2.putText(lffdface_result, 'lffdface waste time:' + str(lffdface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1,
                (0, 0, 255))
    ...
    cv2.putText(libface_result, 'libface waste time:' + str(libface_time), (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1,
                (0, 0, 255))
    ...
    waste_times = (yolo_time, ultraface_time, ssdface_time, retinaface_time, retinaface_dnn_time, mtcnn_time,
                   facebox_time, facebox_dnn_time, dbface_time, centerface_time, lffdface_time, libface_time)
