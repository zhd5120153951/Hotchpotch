...
def LogisticRegression():
    data = loadtxtAndcsv_data("./机器学习/逻辑回归/LogisticRegression/data2.txt", ",", np.float64)
    X = data[:, 0:-1]  #(118,2)--表示118行，2列--二维数组
    y = data[:, -1]  #(118,)--表示的--一维数组-118个元素
