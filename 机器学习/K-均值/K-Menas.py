...
from scipy import misc  # 图片操作--新版中已经移除
import imageio
...
def KMeans():
    '''二维数据聚类过程演示'''
    print(u'聚类过程展示...\n')
    data = spio.loadmat("./机器学习/K-均值/data.mat")
    X = data['X']
    K = 3  # 总类数
    ...
    '''
    print(u'K-Means压缩图片\n')
    # img_data = misc.imread("./机器学习/K-均值/bird.png")  # 读取图片像素数据--新版scipy包移除misc
    img_data = imageio.imread("./机器学习/K-均值/bird.png")
