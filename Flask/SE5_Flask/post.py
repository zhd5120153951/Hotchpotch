...
if __name__ == '__main__':
    ...
    # data = {'device': 'Dell-G15', 'postTime': '2023-11-18',
    # 'img_path': encoded_string, 'ratio': 1.2}
    data = {
        "myName": "post测试", "photo": "this is picture",
        "myTime": "2023-11-18", "inAndout": 1
    }
    header = {"Content-Type": "application/json; charset=utf-8"}
    # print(json.dumps(data))
    try:
        # requests.post("http://127.0.0.1:5002/flask", json.dumps(data), headers=header)
        ret = requests.post("http://47.108.165.167/prod-api/system/kaoqin",
