'''
@FileName   :test.py
@Description:模型测试代码，测试会生成热力图，热力图会保存在results目录下
@Date       :2023/03/04 11:00:35
@Author     :daito
...
def test_mobilenet():
    ...
    train_data, test_data, class_names = data_load("./data/image_data", "./data/test_image_data", 224, 224, 16)
    # todo 加载模型，修改为你的模型名称
    model = models.load_model("models/mobilenet_fv.h5")
    # model.summary()
    # 测试
