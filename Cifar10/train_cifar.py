...
#下载数据集
train_set = datasets.CIFAR10(root="./Cifar10/data/train", train=True, download=True, transform=pipline_train)
test_set = datasets.CIFAR10(root="./Cifar10/data/test", train=False, download=True, transform=pipline_test)
#加载数据集
...
if __name__ == '__main__':
    ...
    print(model)
    torch.save(model, './Cifar10/models/model-cifar10.pth') #保存模型