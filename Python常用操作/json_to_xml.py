...
root = r'/Users/chixu/Downloads/FLIR_ADAS_v2/images_thermal_train/data'  # 你下载的 COCO 数据集所在目录
dataType = '2019'
anno = r'/Users/chixu/Downloads/FLIR_ADAS_v2/images_thermal_train/coco.json'  # annotation json 文件所在位置
xml_dir = r'/Users/chixu/Downloads/FLIR_ADAS_v2/images_thermal_train/images_thermal_train_xml'  # 导出的xml文件所在的位置
