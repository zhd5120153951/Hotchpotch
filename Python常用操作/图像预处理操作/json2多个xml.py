'''
@FileName   :json2多个xml.py
@Description:当我们在使用数据集训练计算机视觉模型时，常常会遇到有的数据集只给了单个的json annotation文件，而模型所需要的annotation是基于每个图片的xml annotation文件，在这里提供笔者所用的json文件转xml文件代码
@Date       :2023/10/07 14:34:51
@Author     :daito
